let quizData = [
  ...
  {
    question: "Apa nama hukum tajwid yang artinya menyamarkan?",
  ...
  {
    question: "Apa arti dari Imalah?",
    options: ["Berhenti", "Miring", "Monyong", "Melebur"],
    correct: "Miring",
  },
  {
    question: "Hukum lam ta'rif bertemu Jim?",
    options: ["Izhar Qamari", "Izhar Halqi", "Idgham Syamsi", "Tarqiq"],
    correct: "Izhar Qamari",
  },
  {
    question: "Apa hukum bacaan ba sukun bertemu mim",
    options: ["Iqlab", "Idgham Mutajanisain", "Idgham Mutaqaribain", "Ikhfa Syafawi"],
    correct: "Idgham Mutajanisain",
  },
  {
    question: "Bacaan Isymam terletak di surah apa?",
    options: ["Yunus", "Yusuf", "Ibrahim", "Al-Kahf"],
    correct: "Yusuf",
  },
  {
